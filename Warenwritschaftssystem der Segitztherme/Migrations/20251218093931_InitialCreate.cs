    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Mitarbeiter",
                columns: new[] { "MitarbeiterID", "Abteilung", "Email", "ErstelltAm", "IstAktiv", "Nachname", "Rolle", "Telefon", "Vorname" },
                values: new object[,]
                {
                    { 1, null, "f.schulz@example.com", new DateTime(2025, 12, 18, 10, 39, 30, 555, DateTimeKind.Local).AddTicks(9742), true, "Schulz", null, "0123456789", "Frankich" },
                    { 2, null, "admin@system.com", new DateTime(2025, 12, 18, 10, 39, 30, 555, DateTimeKind.Local).AddTicks(9748), true, "Admin", null, null, "System" }
                });
